...
// UTC help from: https://stackoverflow.com/questions/948532/how-do-you-convert-a-javascript-date-to-utc
function timeStamp() {
  ...
  var date = [now_utc.getFullYear(), now_utc.getMonth() + 1, now_utc.getDate()];
